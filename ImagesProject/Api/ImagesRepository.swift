...
@MainActor  //Any changes to object that is marked as Published needs to be done on the main thread
class ImagesRepository: ObservableObject {
    
    @Published var images: [ImageData] = []  // spcify any changes to the images list will notify observers
